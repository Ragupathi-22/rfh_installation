...
class RTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: RSizes.fontSizeMd, color: RColors.darkerGrey),
    hintStyle: const TextStyle()
        .copyWith(fontSize: RSizes.fontSizeSm, color: RColors.darkGrey),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    // constraints: const BoxConstraints.expand(height: RSizes.inputFieldHeight),
    labelStyle: const TextStyle()
        .copyWith(fontSize: RSizes.fontSizeMd, color: RColors.darkGrey),
    hintStyle: const TextStyle()
        .copyWith(fontSize: RSizes.fontSizeSm, color: RColors.darkGrey),
    floatingLabelStyle:
